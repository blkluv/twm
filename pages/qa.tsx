...
const QA = () => {
  const copywriting = [
    {
      q: 'What is an NFT trading platform?',
      a: 'An NFT trading platform is an online marketplace that allows users to buy, sell, or trade non-fungible tokens (NFTs). These NFTs represent the unique ownership or rights to digital assets such as digital art, virtual land, game items, and more.',
    },
    {
      q: 'How do I buy an NFT on an NFT trading platform?',
      a: 'First, you need to register an account. Then, you can browse the market of NFTs on the platform and choose the one you want to buy. Once you find an NFT you like, you can click the "buy" button and pay the corresponding currency or cryptocurrency. Once the transaction is completed, you own the NFT.',
    },
    {
  ...
  return (
    <>
      <section className="mt-10 mb-5 space-y-5">
        ...
        <div className="text-xl text-gray-600">Question and Answer</div>
      </section>
      <section>
